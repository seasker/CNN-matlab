 ...
 */
template <typename T>
inline void compute_stochastic_pooling(T *ptr_data, const mwSize *DATA_DIMS, T *ptr_poolsize, T *ptr_poolstride,
...
#pragma omp parallel for
      for (int k = 0; k < DATA_DIMS[2]; ++k) {
          ...
          compute_stochastic_pooling (&ptr_data[data_offset], DATA_DIMS, ptr_poolsize, ptr_poolstride,
