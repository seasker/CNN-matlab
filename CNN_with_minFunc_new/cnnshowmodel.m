...
for l = 1 : n  %  layer
    ...
    elseif strcmp(net.layers{l}.type, 's')
        ...
        fprintf(fid,'Pooling Layer: channels=%d  mapsize=[%d,%d]  kernelsize=[%d,%d]  stride=[%d,%d]  rf=[%d,%d]  ',...
            ...
            net.layers{l}.stride(1),net.layers{l}.stride(2), rf(1), rf(2));
        if isfield(net.layers{l},'activefunc')
            fprintf(fid,'activefunc=%s',func2str(net.layers{l}.activefunc));
        end
